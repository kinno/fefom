      ...
      <v-expansion-panel>
        ...
        >
          <v-col cols="12" sm="6" md="8" class="text-left pa-0">
            ...
            <v-icon color="red darken-2" v-if="alertIluminacion"
          ...
          <v-col cols="12" sm="6" md="4" class="text-right pa-0">
            ...
            <span class="green--text text--lighten-1">{{
              disponible_iluminacion | currency
            }}</span>
          </v-col>
        </v-expansion-panel-header>
        <v-expansion-panel-content>
          <v-row dense>
            ...
            <v-col cols="1" class="pt-4">
              <v-btn
                ...
                @click="agregarProyecto('iluminacion')"
                >Agregar</v-btn
              >
            </v-col>
          </v-row>
          <v-row dense class="mt-0">
            ...
            <v-col cols="6" class="pt-0 pb-0">
              ...
              <v-row dense class="mt-0">
                <v-col cols="12" class="pt-0 pb-0">
                  <v-subheader v-text="'Metas'"></v-subheader>
                </v-col>
              </v-row>
              <v-row dense class="mt-0">
                <v-col cols="6" class="pt-0">
                  <v-text-field
                    v-model="totalIluminacion"
                    dense
          ...
          <v-card>
            <v-data-table
              ...
              :fixed-header="true"
              color="red darken-1"
              class=" mt-0 tablaCartera"
            >
              <template v-slot:item="{ item }">
                <tr>
                  <td width="20%">{{ item.nombre_proyecto }}</td>
                  <td width="20%">{{ item.descripcion_proyecto }}</td>
                  <td width="">{{ item.localidad }}</td>
                  <td width="" class="text-center">{{ item.total_meta }}</td>
                  <td width="" class="text-center">
                    {{ item.unidad_medida_meta }}
                  </td>
                  <td width="10%" class="text-right font-weight-bold">
                    {{ item.monto | currency }}
                  </td>
                  <td width="" class="text-center font-weight-black">
                    {{ item.desc_estatus }}
                  </td>
                  <td width="10%">
                    <v-row>
                      <v-col cols="6" class="pa-0" v-if="item.estatus == 4">
                        <v-btn
                          small
                          height="30px"
                          @click="verObservacion(item, 1)"
                        >
                      ...
                      <v-col
                        cols="6"
                        v-if="item.estatus == 1 || item.estatus == 4"
                        class="pa-0"
                      >
      ...
      <v-expansion-panel>
        ...
        >
          <v-col cols="12" sm="6" md="8" class="text-left pa-0">
            Seguridad
            <!-- <v-icon color="green darken-2">mdi-check-circle-outline</v-icon> -->
            <v-icon color="red darken-2" v-if="alertSeguridad"
              >mdi-alert-octagram</v-icon
            >
          </v-col>
          <v-spacer></v-spacer>
          ...
          <v-row dense>
            ...
            <v-col cols="1" class="pt-4">
              <v-btn
                small
                color="green lighten-3"
                @click="agregarProyecto('seguridad')"
                >Agregar</v-btn
              >
            </v-col>
          </v-row>
      ...
      <v-expansion-panel>
        ...
        >
          <v-col cols="12" sm="6" md="8" class="text-left pa-0">
            ...
            <!-- <v-icon color="green darken-2">mdi-check-circle-outline</v-icon> -->
            <v-icon color="red darken-2" v-if="alertInversion"
              >mdi-alert-octagram</v-icon
            >
          </v-col>
          <v-spacer></v-spacer>
          ...
          <v-row dense>
            ...
            <v-col cols="1" class="pt-4">
              <v-btn
                small
                color="green lighten-3"
                @click="agregarProyecto('inversion')"
                >Agregar</v-btn
              >
            </v-col>
          </v-row>
      ...
      <v-expansion-panel>
        ...
        >
          <v-col cols="12" sm="6" md="8" class="text-left pa-0">
            ...
            <!-- <v-icon color="green darken-2">mdi-check-circle-outline</v-icon> -->
            <v-icon color="red darken-2" v-if="alertDesarrollo"
              >mdi-alert-octagram</v-icon
            >
          </v-col>
          <v-spacer></v-spacer>
          <v-col cols="12" sm="6" md="4" class="text-right pa-0">
            ...
            <br />Monto disponible:
            <span class="green--text text--lighten-1">{{
              disponible_desarrollo | currency
            }}</span>
          </v-col>
        </v-expansion-panel-header>
        <v-expansion-panel-content>
          <v-row dense>
            ...
            <v-col cols="1" class="pt-4">
              <v-btn
                small
                color="green lighten-3"
                @click="agregarProyecto('desarrollo')"
                >Agregar</v-btn
              >
            </v-col>
          </v-row>
      ...
      <v-expansion-panel>
        ...
        >
          <v-col cols="12" sm="6" md="8" class="text-left pa-0">
            Protección Civil
            <!-- <v-icon color="green darken-2">mdi-check-circle-outline</v-icon> -->
            <v-icon color="red darken-2" v-if="alertProteccionCivil"
              >mdi-alert-octagram</v-icon
            >
          </v-col>
          <v-spacer></v-spacer>
          <v-col cols="12" sm="6" md="4" class="text-right pa-0">
            ...
            <br />Monto disponible:
            <span class="green--text text--lighten-1">{{
              disponible_proteccion_civil | currency
            }}</span>
          </v-col>
        </v-expansion-panel-header>
        <v-expansion-panel-content>
          <v-row dense>
            ...
            <v-col cols="1" class="pt-4">
              <v-btn
                small
                color="green lighten-3"
                @click="agregarProyecto('proteccion_civil')"
                >Agregar</v-btn
              >
            </v-col>
          </v-row>
          <v-row dense>
            ...
            <v-col cols="6" class="pt-0 pb-0">
              <v-row dense>
                <v-col cols="12" class="pt-0 pb-0">
                  <v-text-field
                    v-model="localidadProteccionCivil"
                    dense
                    label="Localidad (es)"
                    outlined
                  ></v-text-field>
      ...
      <v-expansion-panel>
        ...
        >
          <v-col cols="12" sm="6" md="8" class="text-left pa-0">
            ...
            <!-- <v-icon color="green darken-2">mdi-check-circle-outline</v-icon> -->
            <v-icon color="red darken-2" v-if="alertNoEtiquetado"
              >mdi-alert-octagram</v-icon
            >
          </v-col>
          <v-spacer></v-spacer>
          <v-col cols="12" sm="6" md="4" class="text-right pa-0">
            ...
            <br />Monto disponible:
            <span class="green--text text--lighten-1">{{
              disponible_no_etiquetado | currency
            }}</span>
          </v-col>
        </v-expansion-panel-header>
        <v-expansion-panel-content>
          <v-row dense>
            ...
            <v-col cols="1" class="pt-4">
              <v-btn
                small
                color="green lighten-3"
                @click="agregarProyecto('no_etiquetado')"
                >Agregar</v-btn
              >
            </v-col>
          </v-row>
...
export default {
  ...
  data: () => ({
    ...
    localidadProteccionCivil: "",
    totalProteccionCivil: "",
    unidadProteccionCivil: "",
    obraNoEtiquetado: "",
    montoNoEtiquetado: "",
    descripcionNoEtiquetado: "",
    localidadNoEtiquetado: "",
    totalNoEtiquetado: "",
    unidadNoEtiquetado: ""
    // obraRetencion: "",
    // montoRetencion: "".
  ...
  methods: {
      ...
      switch (rubro) {
        case "iluminacion":
          if (
            ...
            this.$http
              .post("/cartera_proyectos/agregar_proyecto", {
                ejercicio: this.ejercicioSeleccionado,
                id_municipio: this.user.id_municipio,
                nombre_proyecto: this.obraIluminacion,
                monto: this.montoIluminacion,
                descripcion_proyecto: this.descripcionIluminacion,
                localidad: this.localidadIluminacion,
                total_meta: this.totalIluminacion,
                unidad_medida_meta: this.unidadIluminacion,
                id_rubro: 1,
                estatus: 1
              })
              .then(response => {
                if (response.status == 200) {
                  ...
                  this.localidadIluminacion = "";
                  this.totalIluminacion = "";
                  this.unidadIluminacion = "";
                } else {
          ...
          if (
            ...
            this.$http
              .post("/cartera_proyectos/agregar_proyecto", {
                ...
                localidad: this.localidadSeguridad,
                total_meta: this.totalSeguridad,
                unidad_medida_meta: this.unidadSeguridad,
                id_rubro: 2,
                estatus: 1
              })
              .then(response => {
                if (response.status == 200) {
                  ...
                  this.localidadSeguridad = "";
                  this.totalSeguridad = "";
                  this.unidadSeguridad = "";
                } else {
                  console.log("Error", response.err);
                }
              })
          ...
          if (
            ...
            this.$http
              .post("/cartera_proyectos/agregar_proyecto", {
                ...
                localidad: this.localidadInversion,
                total_meta: this.totalInversion,
                unidad_medida_meta: this.unidadInversion,
                id_rubro: 3,
                estatus: 1
              })
              .then(response => {
                if (response.status == 200) {
                  ...
                  this.localidadInversion = "";
                  this.totalInversion = "";
                  this.unidadInversion = "";
                } else {
                  console.log("Error", response.err);
                }
              })
          ...
          if (
            ...
            this.$http
              .post("/cartera_proyectos/agregar_proyecto", {
                ...
                localidad: this.localidadDesarrollo,
                total_meta: this.totalDesarrollo,
                unidad_medida_meta: this.unidadDesarrollo,
                id_rubro: 4,
                estatus: 1
              })
              .then(response => {
                if (response.status == 200) {
                  ...
                  this.localidadDesarrollo = "";
                  this.totalDesarrollo = "";
                  this.unidadDesarrollo = "";
                } else {
                  console.log("Error", response.err);
                }
              })
          ...
          if (
            ...
            this.$http
              .post("/cartera_proyectos/agregar_proyecto", {
                ...
                localidad: this.localidadProteccionCivil,
                total_meta: this.totalProteccionCivil,
                unidad_medida_meta: this.unidadProteccionCivil,
                id_rubro: 5,
                estatus: 1
              })
              .then(response => {
                if (response.status == 200) {
                  ...
                  this.localidadProteccionCivil = "";
                  this.totalProteccionCivil = "";
                  this.unidadProteccionCivil = "";
                } else {
                  console.log("Error", response.err);
                }
              })
          ...
          if (
            ...
            this.$http
              .post("/cartera_proyectos/agregar_proyecto", {
                ...
                localidad: this.localidadNoEtiquetado,
                total_meta: this.totalNoEtiquetado,
                unidad_medida_meta: this.unidadNoEtiquetado,
                id_rubro: 6,
                estatus: 1
              })
              .then(response => {
                if (response.status == 200) {
                  ...
                  this.localidadNoEtiquetado = "";
                  this.totalNoEtiquetado = "";
                  this.unidadNoEtiquetado = "";
                } else {
                  console.log("Error", response.err);
                }
              })
    ...
    verificarCierre() {
      if (
        ...
        if (
          ...
          return {
            response: false,
            error: "Existen proyectos con observaciones por parte del FEFOM.",
            subError:
              "Recordatorio: No se puede cerrar la cartera mientras existan proyectos con Observaciones."
          };
        }
      } else {
        return {
      ...
      switch (rubro) {
        case 1:
          ...
          if (confirm("¿Deseas eliminar este proyecto?")) {
            this.$http
              .post("/cartera_proyectos/eliminar_proyecto", {
            ...
            this.$http
              ...
              .then(response => {
                ...
                if (response.status == 200) {
                  ...
                  for (
                    let i = 0;
                    i < this.proyectosProteccionCivil.length;
                    i++
                  ) {
    ...
    imprimirCartera() {
      ...
      if (valVerifica.response) {
        ...
        var techos = [{
          nombre: "Iluminación municipal",
          porc: this.porc_iluminacion_municipal,
          techo: this.techo_asignado_iluminacion_municipal,
          proyectos: this.proyectosIluminacion
        },
        {
          nombre:"Seguridad",
          porc: this.porc_seguridad,
          techo: this.techo_asignado_seguridad,
          proyectos: this.proyectosSeguridad,
        },
        {
          nombre:"Inversión Pública",
          porc: this.porc_inversion_publica,
          techo: this.techo_asignado_inversion_publica,
          proyectos: this.proyectosInversion,
        },
        {
          nombre:"Acciones para el desarrollo",
          porc: this.porc_desarrollo,
         techo: this.techo_asignado_desarrollo,
          proyectos: this.proyectosDesarrollo,
        },
        {
          nombre:"Protección Civil",
          porc: this.porc_proteccion_civil,
         techo: this.techo_asignado_proteccion_civil,
          proyectos: this.proyectosProteccionCivil,
        },
        {
          nombre:"Recursos no etiquetados",
          porc: this.porc_no_etiquetado,
          techo: this.techo_asignado_no_etiquetado,
          proyectos: this.proyectosNoEtiquetado,
        },
        ]
        var techo_etiquetado = +this.techo_asignado_iluminacion_municipal + +this.techo_asignado_seguridad + +this.techo_asignado_inversion_publica + +this.techo_asignado_desarrollo + +this.techo_asignado_proteccion_civil
        this.$http
          .get("/cartera_proyectos/imprimir_cartera", {
            responseType: "arraybuffer",
            params: {
              ejercicio: this.ejercicioSeleccionado,
              id_municipio: this.user.id_municipio,
              techo_total: this.montoTotal,
              techo_etiquetado: techo_etiquetado,
              techos: JSON.stringify(techos),
            }
          })
          .then(response => {
            // console.log(response);
...
<style lang="css">
.tablaCartera table > thead > tr > th {
  background-color: #e8f5e9 !important;
  font-size: 12px !important;
  border: 1px solid #e6e6e6;
}
.tablaCartera table > tbody > tr > td {
